...
for d in range(0,N):
	...
	os.system(f"combine -M AsymptoticLimits {path+str(d)}.txt -m {str(m)} -n asympMassIndex_{str(d)} --cminDefaultMinimizerStrategy 0 --rAbsAcc=0.0001 --rRelAcc=0.0001 --setParameters pdf_index_2022=0 --run blind") # --rMin -1 --rMax 1 