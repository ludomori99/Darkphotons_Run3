...
void multi_fit(int event_frac = 15)
{
    ...
    RooRealVar ql_Jpsi("ql_Jpsi", "Scale of sigma of left CB ql_Jpsi", 1, 0.5, 2, "");
    RooRealVar qr_Jpsi("qr_Jpsi", "Scale of sigma of right CB qr_Jpsi", 1, 0.5, 2, "");
    RooRealVar ql_Psi2("ql_Psi2", "Scale of sigma of left CB ql_Psi2", 1, 0.5, 2, "");
    RooRealVar qr_Psi2("qr_Psi2", "Scale of sigma of right CB qr_Psi2", 1, 0.5, 2, "");

    RooRealVar nL("nL", "nL CB", 5, 3,15, "");
    RooRealVar alphaL("alphaR", "Alpha right CB", 3, 2, 5, "");
    RooRealVar nR("nR", "nR CB", 5, 3,15, "");
    RooRealVar alphaR("alphaL", "Alpha left CB", 3, 2, 5, "");
    ...
    RooRealVar bkgDecayConst_Jpsi("bkgDecayConst_Jpsi", "Decay const for bkg mass spectrum", -1., -3, 3, "1/GeV");
