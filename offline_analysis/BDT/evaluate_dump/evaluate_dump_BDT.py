...
off_file_name = os.path.join("/data/submit/",config["locations"]["offline"]["dump"], f"DimuonTree{njob}.root")
...
with up.create(os.path.join("/data/submit/",config["locations"]["offline"]["dump_post_BDT"], f"DimuonTree{njob}_BDT.root")) as output_file:
