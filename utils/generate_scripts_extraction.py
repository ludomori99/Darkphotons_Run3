...
for (( N=start; N<end; N++ )); do
    ...
    echo running $file
    root -l -b -q generateMCDimuonTree.C\(\"$file\"\,\"{MC_lmDY_tmp_dir}DimuonTreeTMP$1_$N.root\"\,{MC_lmDY_event_fraction}\)
    hadd {MC_lmDY_dump_dir}DimuonTree$1.root {MC_lmDY_tmp_dir}DimuonTreeTMP$1_*.root
